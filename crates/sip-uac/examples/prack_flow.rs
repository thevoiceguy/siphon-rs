...
fn main() {
    ...
    ringing_headers.push(SmolStr::new("CSeq"), SmolStr::new("1 INVITE")).unwrap();
    ringing_headers.push(SmolStr::new("RSeq"), SmolStr::new("1")).unwrap();
    ringing_headers.push(
        SmolStr::new("Contact"),
        SmolStr::new("<sip:bob@192.168.1.200:5060>"),
    ).unwrap();
    ringing_headers.push(SmolStr::new("Require"), SmolStr::new("100rel")).unwrap();
