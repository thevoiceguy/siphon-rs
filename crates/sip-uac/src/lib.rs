...
pub mod auth_utils;
pub mod integrated;
pub use integrated::{CredentialProvider, Flow, SessionTimerState, SessionTimerStop};
...
impl UserAgentClient {
    ...
    /// Creates an unsolicited NOTIFY with a custom Subscription-State value.
    ///
    /// Identical to `create_unsolicited_notify` but allows specifying the
    /// Subscription-State header (e.g., `"active;expires=3600"` or
    /// `"terminated;reason=deactivated"`).
    pub fn create_unsolicited_notify_with_state(
        &self,
        target: &SipUri,
        event: &str,
        content_type: &str,
        ...
        headers
            .push(
                ...
                SmolStr::new(subscription_state),
            )
            .unwrap();
    ...
    pub fn create_register(&self, registrar_uri: &SipUri, expires: u32) -> Request {
        ...
        // Expires header
        headers
            .push(SmolStr::new("Expires"), SmolStr::new(expires.to_string()))
            .unwrap();
                    ...
                    for route in service_route.routes() {
                        ...
                        new_headers.push(
                            Header::new("Route", route_value)
                                .expect("route header should be valid"),
                        );
                    }
                    inserted = true;
                }
    ...
    pub fn create_authenticated_request_with(
        ...
        new_headers
            .push(SmolStr::new(response_header_name), SmolStr::new(auth_value))
            .unwrap();
    ...
    pub fn create_bye(&self, dialog: &Dialog) -> Request {
        ...
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new(format!("{} BYE", cseq)))
            .unwrap();
    ...
    pub fn create_publish(
        ...
        let from = self.format_from_header();
        headers
            .push(SmolStr::new("From"), SmolStr::new(from.clone()))
            .unwrap();
        headers
            .push(
                SmolStr::new("To"),
        ...
        headers
            ...
            .unwrap();
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new("1 PUBLISH"))
            .unwrap();
        headers
            .push(SmolStr::new("Event"), SmolStr::new(event))
            .unwrap();
    ...
    pub fn create_info(
        ...
        let cseq = mutable_dialog.next_local_cseq();
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new(format!("{} INFO", cseq)))
            .unwrap();
    ...
    fn build_prack_request(&self, dialog: &Dialog, rack_value: String) -> Result<Request> {
        let mut headers = Headers::new();
        ...
        headers
            .push(SmolStr::new("RAck"), SmolStr::new(rack_value))
            .unwrap();
    ...
    pub fn create_reg_notify(
        ...
        // Event: reg
        headers
            .push(SmolStr::new("Event"), SmolStr::new("reg"))
            .unwrap();
    ...
    pub fn create_message(&self, target_uri: &SipUri, content_type: &str, body: &str) -> Request {
        ...
        // CSeq
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new("1 MESSAGE"))
            .unwrap();
...
mod tests {
    ...
    fn creates_refer_with_replaces() {
        ...
        let _ = headers1.push(SmolStr::new("Call-ID"), SmolStr::new("call-1"));
        let _ = headers1.push(SmolStr::new("CSeq"), SmolStr::new("1 INVITE"));
        let _ = headers1.push(
            SmolStr::new("Contact"),
            SmolStr::new("<sip:bob@192.168.1.200:5060>"),
        );
        ...
        let _ = headers2.push(SmolStr::new("Call-ID"), SmolStr::new("call-2"));
        let _ = headers2.push(SmolStr::new("CSeq"), SmolStr::new("1 INVITE"));
        let _ = headers2.push(
            SmolStr::new("Contact"),
    ...
    fn creates_notify_request() {
        ...
        headers
            ...
            .unwrap();
        headers
            .push(SmolStr::new("Call-ID"), SmolStr::new("sub-call-id"))
            .unwrap();
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new("1 SUBSCRIBE"))
            .unwrap();
    ...
    fn prack_from_provisional_uses_response_cseq_and_rseq() {
        ...
        let mut headers = Headers::new();
        headers
            .push(SmolStr::new("RSeq"), SmolStr::new("42"))
            .unwrap();
        headers
            .push(SmolStr::new("CSeq"), SmolStr::new("7 INVITE"))
            .unwrap();
        headers
            .push(
                SmolStr::new("To"),
                SmolStr::new("<sip:bob@example.com>;tag=rtag"),
            )
            .unwrap();
        headers
            .push(
            ...
            .unwrap();
        headers
            .push(SmolStr::new("Call-ID"), SmolStr::new("call-id"))
            .unwrap();
