...
pub fn build_prack(uri: &str, rack: &str, call_id: &str, cseq: u32) -> Request {
    ...
    headers.push_unchecked(SmolStr::new("To"), SmolStr::new("<sip:bob@example.com>"));
    headers.push_unchecked(SmolStr::new("Call-ID"), SmolStr::new(call_id));
    headers.push_unchecked(SmolStr::new("CSeq"), SmolStr::new(format!("{} PRACK", cseq)));
    headers.push_unchecked(SmolStr::new("RAck"), SmolStr::new(rack));
    headers.push_unchecked(SmolStr::new("Max-Forwards"), SmolStr::new("70"));
    headers.push_unchecked(
        SmolStr::new("Contact"),
        SmolStr::new("<sip:alice@client.example.com:5060>"),
...
pub fn build_refer(uri: &str, refer_to: &str, call_id: &str, cseq: u32) -> Request {
    ...
    headers.push_unchecked(SmolStr::new("To"), SmolStr::new("<sip:bob@example.com>"));
    headers.push_unchecked(SmolStr::new("Call-ID"), SmolStr::new(call_id));
    headers.push_unchecked(SmolStr::new("CSeq"), SmolStr::new(format!("{} REFER", cseq)));
    headers.push_unchecked(
        SmolStr::new("Contact"),
        SmolStr::new("<sip:alice@client.example.com:5060>"),
    );
    headers.push_unchecked(SmolStr::new("Refer-To"), SmolStr::new(refer_to));
    headers.push_unchecked(SmolStr::new("Max-Forwards"), SmolStr::new("70"));
    headers.push_unchecked(SmolStr::new("Content-Length"), SmolStr::new("0"));
...
pub fn build_provisional_with_rseq(code: u16, reason: &str, rack_cseq: u32) -> Response {
    ...
    resp.headers.push_unchecked(SmolStr::new("Require"), SmolStr::new("100rel"));
    resp.headers
        .push_unchecked(SmolStr::new("RSeq"), SmolStr::new(rack_cseq.to_string()));
    resp
}
...
pub fn build_register(uri: &str, contact: &str) -> Request {
    ...
    headers.push_unchecked(SmolStr::new("To"), SmolStr::new("<sip:alice@example.com>"));
    headers.push_unchecked(
        SmolStr::new("Call-ID"),
    ...
    headers.push_unchecked(SmolStr::new("Max-Forwards"), SmolStr::new("70"));
    headers.push_unchecked(SmolStr::new("Contact"), SmolStr::new(contact));
...
pub fn build_notify_for_refer(
    ...
    headers.push_unchecked(SmolStr::new("CSeq"), SmolStr::new("1 NOTIFY"));
    headers.push_unchecked(SmolStr::new("Max-Forwards"), SmolStr::new("70"));
    headers.push_unchecked(
        SmolStr::new("Contact"),
    ...
    headers.push_unchecked(SmolStr::new("Content-Type"), SmolStr::new("message/sipfrag"));
    headers.push_unchecked(SmolStr::new("Content-Length"), SmolStr::new("0"));
